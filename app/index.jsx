...
export default function Index() {
  ...
  // FetchData-funktion - Async Data Storage
  useEffect(() => {
  ...
  // StoreData-funktion - Async Data Storage
  useEffect(() => {
  ...
  // Funktion (til dynamic routing ved klik på knap)
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        {/* Kan refaktoreres fx kig i [id].jsx */}
        <Pressable
